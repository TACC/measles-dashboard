...
def bottom_info_section():
    return html.Div([
            ...
            #        style={"color": "#1b96bf", "textDecoration": "none"}),
            # html.A("]."),
            # html.A(" For the state of North Carolina, the data are the percent of kindergarten students who received all required MMR doses, as reported by the North Carolina Department of Health and Human Services for the 2023-2024 school year ["),
            # html.A("NCDHHS Kindergarten Immunization Data Dashboard",
            #        href="https://www.dph.ncdhhs.gov/programs/epidemiology/immunization/data/kindergarten-dashboard", target="_blank",
            #        style={"color": "#1b96bf", "textDecoration": "none"}),
            # html.A("]."),
            # html.A(" For the state of Pennsylvania, the data are the percent of kindergarten, 7th grade or 12th grade students who received two MMR doses or more, as reported by the Pennsylvania Department of Health for the 2023-2024 school year ["),
            # html.A("Pennsylvania DOH School Immunization Rates",
            #        href="https://www.pa.gov/agencies/health/programs/immunizations/rates.html", target="_blank",
            #        style={"color": "#1b96bf", "textDecoration": "none"}),
            # html.A("]."),
